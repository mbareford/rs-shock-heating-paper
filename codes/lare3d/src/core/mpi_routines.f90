...
CONTAINS
  ...
  SUBROUTINE mpi_initialise
    ...
    ALLOCATE(visc_heat(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(ohmic_heat(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_xy(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_xz(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_yz(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_xx(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_yy(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(visc_heat_zz(-1:nx+2, -1:ny+2, -1:nz+2))

    ALLOCATE(dis_dzbx_w(-2:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(dis_dzby_w(-1:nx+2, -2:ny+2, -1:nz+2))

    ALLOCATE(eta(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(eta_num(-1:nx+2, -1:ny+2, -1:nz+2))
    ALLOCATE(j_crit(-1:nx+2, -1:ny+2, -1:nz+2))
    ...
    ALLOCATE(rho_r(0:nx+1, 0:ny+1, 0:nz+1))
    ALLOCATE(fx_r(-1:nx+1, -1:ny+1, -1:nz+1))
    ALLOCATE(fy_r(-1:nx+1, -1:ny+1, -1:nz+1))
    ALLOCATE(fz_r(-1:nx+1, -1:ny+1, -1:nz+1))    
  ...
  SUBROUTINE mpi_close
    ...
    DEALLOCATE(bx, by, bz)
    DEALLOCATE(p_visc)
    DEALLOCATE(visc_heat)
    DEALLOCATE(ohmic_heat)
    DEALLOCATE(visc_heat_xy,visc_heat_xz,visc_heat_yz)
    DEALLOCATE(visc_heat_xx,visc_heat_yy,visc_heat_zz)
    DEALLOCATE(dis_dzbx_w,dis_dzby_w)
    DEALLOCATE(eta, eta_num, j_crit)
    DEALLOCATE(cv, cv1)
    DEALLOCATE(xc, xb, dxb, dxc)
    DEALLOCATE(yc, yb, dyb, dyc)
    DEALLOCATE(grav)
    DEALLOCATE(jx_r, jy_r, jz_r, rho_r)
    DEALLOCATE(fx_r, fy_r, fz_r) 
