    ...
    DO iz = 1, nz
      DO iy = 0, ny
        DO ix = 1, nx
          ...
          dA = dxb(ix)*dzb(iz)
          b0 = by(ix,iy,iz)/dA
          dflux = (flux(ixm,iy,iz)-flux(ix,iy,iz))/dA
          dxby1_w = dxby1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 1, nz
      DO iy = 1, ny
        ...
        DO ix = 0, nx
          ...
          dA = dyb(iy)*dzb(iz)
          b0 = bx(ix,iy,iz)/dA
          dflux = (flux(ix,iy,iz)-flux(ix,iym,iz))/dA
          dybx2_w = dybx2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 0, nz
      DO iy = 1, ny
        DO ix = 1, nx
          ...
          b0 = bz(ix,iy,iz)/dA
          dflux = (flux(ixm,iy,iz)-flux(ix,iy,iz))/dA
          dxbz1_w = dxbz1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 1, nz
      ...
      DO iy = 1, ny
        DO ix = 0, nx
          ...
          dA = dyb(iy)*dzb(iz)
          b0 = bx(ix,iy,iz)/dA
          dflux = (flux(ix,iy,iz)-flux(ix,iy,izm))/dA
          dzbx2_w = dzbx2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
          dis_dzbx_w(ix,iy,iz) = (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
