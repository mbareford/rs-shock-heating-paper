    ...
    DO iz = 1, nz
      ...
      DO iy = 1, ny
        DO ix = 0, nx
          ...
          dA = dyb(iy)*dzb(iz)
          b0 = bx(ix,iy,iz)/dA
          dflux = (flux(ix,iy,izm)-flux(ix,iy,iz))/dA
          dzbx1_w = dzbx1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 0, nz
      DO iy = 1, ny
        DO ix = 1, nx
          ...
          dxbz2_w = dxbz2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 1, nz
      ...
      DO iy = 0, ny
        DO ix = 1, nx
          ...
          b0 = by(ix,iy,iz)/dA
          dflux = (flux(ix,iy,izm)-flux(ix,iy,iz))/dA
          dzby1_w = dzby1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 0, nz
      DO iy = 1, ny
        ...
        DO ix = 1, nx
          ...
          dybz2_w = dybz2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
