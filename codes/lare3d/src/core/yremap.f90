    ...
    DO iz = 1, nz
      DO iy = 1, ny
        ...
        DO ix = 0, nx
          ...
          dA = dyb(iy)*dzb(iz)
          b0 = bx(ix,iy,iz)/dA
          dflux = (flux(ix,iym,iz)-flux(ix,iy,iz))/dA
          dybx1_w = dybx1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)          
    ...
    DO iz = 1, nz
      DO iy = 0, ny
        DO ix = 1, nx
          ...
          dA = dxb(ix)*dzb(iz)
          b0 = by(ix,iy,iz)/dA
          dflux = (flux(ix,iy,iz)-flux(ixm,iy,iz))/dA
          dxby2_w = dxby2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 0, nz
      DO iy = 1, ny
        ...
        DO ix = 1, nx
          ...
          b0 = bz(ix,iy,iz)/dA
          dflux = (flux(ix,iym,iz)-flux(ix,iy,iz))/dA
          dybz1_w = dybz1_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
    ...
    DO iz = 1, nz
      ...
      DO iy = 0, ny
        DO ix = 1, nx
          ...
          dzby2_w = dzby2_w + (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
          dis_dzby_w(ix,iy,iz) = (0.5_num*(dflux**2) + b0*dflux)*cv(ix,iy,iz)
